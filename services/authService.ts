...
export let MOCK_USERS: MockUser[] = [
  // Master Users
  { id: 'user_adelar', email: 'adelar@master', full_name: 'Adelar', role: 'admin', company_id: 'comp_master', active: true, password: '123456' },
  { id: 'user_gustavo', email: 'gustavo@master', full_name: 'Gustavo', role: 'admin', company_id: 'comp_master', active: true, password: '123456' },
  { id: 'user_marcia', email: 'marcia@master', full_name: 'Márcia', role: 'user', company_id: 'comp_master', active: true, password: '123456' },
  
  // AMX Users
  { id: 'user_junior', email: 'junior@amx', full_name: 'Junior', role: 'admin', company_id: 'comp_amx', active: true, password: '123456' },
  { id: 'user_kayllane', email: 'kayllane@amx', full_name: 'Kayllane', role: 'user', company_id: 'comp_amx', active: true, password: '123456' },
  { id: 'user_miguel', email: 'miguel@amx', full_name: 'Miguel', role: 'user', company_id: 'comp_amx', active: true, password: '123456' }
];
